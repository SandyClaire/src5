...
public class GattDescriptorDetails extends Fragment implements
    ...
    private BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
			LogUtil.e("GattDescriptorDetails", "mGattUpdateReceiver  onReceive()");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		LogUtil.e("GattDescriptorDetails", "onCreateView()");
    ...
    private void displayDescriptorValue(String value) {
		LogUtil.e("GattDescriptorDetails", "displayDescriptorValue()");
        mDescriptorValue.setText(value);
    }

    void displayHexValue(byte[] array) {
		LogUtil.e("GattDescriptorDetails", "displayHexValue()");
    ...
    public void onResume() {
        super.onResume();
		LogUtil.e("GattDescriptorDetails", "onResume()");
    ...
    public void onDestroy() {
        super.onDestroy();
		LogUtil.e("GattDescriptorDetails", "onDestroy()");
    ...
    public void onClick(View view) {
		LogUtil.e("GattDescriptorDetails", "onClick()");
        switch (view.getId()) {
    ...
    void prepareBroadcastDataNotify(
        ...
        LogUtil.e("GattDescriptorDetails", "prepareBroadcastDataNotify()");
    ...
    void stopBroadcastDataNotify(
            BluetoothGattCharacteristic gattCharacteristic) {
        LogUtil.e("GattDescriptorDetails", "stopBroadcastDataNotify()");
        final BluetoothGattCharacteristic characteristic = gattCharacteristic;
        final int charaProp = characteristic.getProperties();
    ...
    void prepareBroadcastDataIndicate(
            BluetoothGattCharacteristic gattCharacteristic) {
        LogUtil.e("GattDescriptorDetails", "prepareBroadcastDataIndicate()");
        final BluetoothGattCharacteristic characteristic = gattCharacteristic;
        final int charaProp = characteristic.getProperties();
    ...
    void stopBroadcastDataIndicate(
            BluetoothGattCharacteristic gattCharacteristic) {
        LogUtil.e("GattDescriptorDetails", "stopBroadcastDataIndicate()");
        final BluetoothGattCharacteristic characteristic = gattCharacteristic;
        final int charaProp = characteristic.getProperties();
    ...
    boolean getGattCharacteristicsPropertices(int characteristics,
		...
		LogUtil.e("GattDescriptorDetails", "getGattCharacteristicsPropertices()");
