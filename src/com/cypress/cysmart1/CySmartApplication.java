...
public class CySmartApplication extends Application {
    ...
    public BluetoothGattCharacteristic getBluetoothgattcharacteristic() {
        LogUtil.e("CySmartApplication", "getBluetoothgattcharacteristic()");
    ...
    public void setBluetoothgattcharacteristic(
        ...
        LogUtil.e("CySmartApplication", "setBluetoothgattcharacteristic()");
    ...
    public BluetoothGattDescriptor getBluetoothgattDescriptor() {
        LogUtil.e("CySmartApplication", "getBluetoothgattDescriptor()");
    ...
    public void setBluetoothgattdescriptor(
        ...
        LogUtil.e("CySmartApplication", "setBluetoothgattdescriptor()");
    ...
    public List<BluetoothGattCharacteristic> getGattCharacteristics() {
        LogUtil.e("CySmartApplication", "getGattCharacteristics()");
    ...
    public void setGattCharacteristics(
        ...
        LogUtil.e("CySmartApplication", "setGattCharacteristics()");
    ...
    public ArrayList<HashMap<String, BluetoothGattService>> getGattServiceMasterData() {
        LogUtil.e("CySmartApplication", "getGattServiceMasterData()");
    ...
    public void setGattServiceMasterData(
        ...
        LogUtil.e("CySmartApplication", "setGattServiceMasterData()");
