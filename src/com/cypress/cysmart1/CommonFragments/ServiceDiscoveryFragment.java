...
public class ServiceDiscoveryFragment extends Fragment {
    ...
    private final BroadcastReceiver mServiceDiscoveryListner=new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtil.e("ServiceDiscoveryFragment", "mServiceDiscoveryListner  onReceive()");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        LogUtil.e("ServiceDiscoveryFragment", "onCreateView()");
    ...
    private Timer showServiceDiscoveryAlert(boolean isReconnect) {
        LogUtil.e("ServiceDiscoveryFragment", "showServiceDiscoveryAlert()");
    ...
    private void prepareGattServices(List<BluetoothGattService> gattServices) {
        LogUtil.e("ServiceDiscoveryFragment", "prepareGattServices()");
    ...
    boolean isSensorHubPresent(List<BluetoothGattService> gattServices) {
        LogUtil.e("ServiceDiscoveryFragment", "isSensorHubPresent()");
    ...
    private void prepareSensorHubData(List<BluetoothGattService> gattServices) {
        LogUtil.e("ServiceDiscoveryFragment", "prepareSensorHubData()");
    ...
    private void updateWithNewFragment() {
        LogUtil.e("ServiceDiscoveryFragment", "updateWithNewFragment()");
        mProgressDialog.dismiss();
    ...
    private void prepareData(List<BluetoothGattService> gattServices) {
        LogUtil.e("ServiceDiscoveryFragment", "prepareData()");
    ...
    private void showNoServiceDiscoverAlert() {
        LogUtil.e("ServiceDiscoveryFragment", "showNoServiceDiscoverAlert()");
    ...
    public void onPause() {
        super.onPause();
        LogUtil.e("ServiceDiscoveryFragment", "onPause()");
    ...
    public void onResume() {
        super.onResume();
        LogUtil.e("ServiceDiscoveryFragment", "onResume()");
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        LogUtil.e("ServiceDiscoveryFragment", "onCreateOptionsMenu()");
        menu.clear();
