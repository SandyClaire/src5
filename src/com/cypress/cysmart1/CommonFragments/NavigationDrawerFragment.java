...
import com.cypress.cysmart1.DataModelClasses.NavigationDrawerModel;
import com.cypress.cysmart1.ListAdapters.NavDrawerExpandableListAdapter;
import com.cypress.cysmart1.ListAdapters.NavDrawerListAdapter;
...
public class NavigationDrawerFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LogUtil.e("NavigationDrawerFragment", "onCreate()");
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        LogUtil.e("NavigationDrawerFragment", "onActivityCreated()");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LogUtil.e("NavigationDrawerFragment", "onCreateView()");
    ...
    private void selectChildView(String childText) {
        LogUtil.e("NavigationDrawerFragment", "selectChildView()");
    ...
    void displayView(Fragment fragment) {
        LogUtil.e("NavigationDrawerFragment", "displayView()");
    ...
    public boolean isDrawerOpen() {
        LogUtil.e("NavigationDrawerFragment", "isDrawerOpen()");
    ...
    public void setUp(int fragmentId, DrawerLayout drawerLayout) {
        LogUtil.e("NavigationDrawerFragment", "setUp()");
        ...
        mDrawerToggle = new ActionBarDrawerToggle(getActivity(), /* host Activity */
            ...
            public void onDrawerClosed(View drawerView) {
                ...
                LogUtil.e("NavigationDrawerFragment", "mDrawerToggle  onDrawerClosed()");
                if (!isAdded()) {
                    return;
                }
            ...
            public void onDrawerOpened(View drawerView) {
                ...
                LogUtil.e("NavigationDrawerFragment", "mDrawerToggle  onDrawerOpened()");
                if (!isAdded()) {
                    return;
                }
        ...
        mDrawerLayout.post(new Runnable() {
            @Override
            public void run() {
                LogUtil.e("NavigationDrawerFragment", "mDrawerLayout  run()");
    ...
    void selectItem(int position) {
        LogUtil.e("NavigationDrawerFragment", "selectItem()");
    ...
    public void onAttach(Activity activity) {
        ...
        LogUtil.e("NavigationDrawerFragment", "onAttach()");
        try {
    ...
    public void onDetach() {
        super.onDetach();
        LogUtil.e("NavigationDrawerFragment", "onDetach()");
        mCallbacks = null;
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        LogUtil.e("NavigationDrawerFragment", "onSaveInstanceState()");
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        LogUtil.e("NavigationDrawerFragment", "onConfigurationChanged()");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        LogUtil.e("NavigationDrawerFragment", "onOptionsItemSelected()");
