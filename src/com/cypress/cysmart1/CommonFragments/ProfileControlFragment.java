...
import com.cypress.cysmart1.ListAdapters.CarouselPagerAdapter;
...
public class ProfileControlFragment extends Fragment {
    ...
    public ProfileControlFragment create(String device_name,
        ...
        LogUtil.e("ProfileControlFragment", "create()");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LogUtil.e("ProfileControlFragment", "onCreateView()");
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        LogUtil.e("ProfileControlFragment", "onConfigurationChanged()");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LogUtil.e("ProfileControlFragment", "onCreate()");
    ...
    public void onResume() {
        super.onResume();
        LogUtil.e("ProfileControlFragment", "onResume()");
    ...
    private void checkConnectionStatus() {
        if (BluetoothLeService.getConnectionState() == 0) {
            LogUtil.e("ProfileControlFragment", "checkConnectionStatus()");
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        LogUtil.e("ProfileControlFragment", "onCreateOptionsMenu()");
        menu.clear();
    ...
    private void setCarouselView() {
        LogUtil.e("ProfileControlFragment", "setCarouselView()");
