...
public class SensorHubParser {
    ...
    public static int getAcceleroMeterXYZReading(
        ...
        LogUtil.e("SensorHubParser", "getAcceleroMeterXYZReading()");
    ...
    public static float getThermometerReading(
            BluetoothGattCharacteristic characteristic) {
        LogUtil.e("SensorHubParser", "getThermometerReading()");
    ...
    public static int getBarometerReading(
            BluetoothGattCharacteristic characteristic) {
        LogUtil.e("SensorHubParser", "getBarometerReading()");
    ...
    public static int getSensorScanIntervalReading(
            BluetoothGattCharacteristic characteristic) {
        LogUtil.e("SensorHubParser", "getSensorScanIntervalReading()");
    ...
    public static int getSensorTypeReading(
            BluetoothGattCharacteristic characteristic) {
        LogUtil.e("SensorHubParser", "getSensorTypeReading()");
    ...
    public static int getFilterConfiguration(
            BluetoothGattCharacteristic characteristic) {
        LogUtil.e("SensorHubParser", "getFilterConfiguration()");
    ...
    public static int getThresholdValue(
            BluetoothGattCharacteristic characteristic) {
        LogUtil.e("SensorHubParser", "getThresholdValue()");
