...
public class HealthTemperatureService extends Fragment {
    ...
    private BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
			LogUtil.e("HealthTemperatureService", "onReceive()");
    ...
    public HealthTemperatureService create(BluetoothGattService service) {
		LogUtil.e("HealthTemperatureService", "create()");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		LogUtil.e("HealthTemperatureService", "onCreateView()");
    ...
    private void displayLiveData(final ArrayList<String> htm_data) {
		LogUtil.e("HealthTemperatureService", "displayLiveData()");
        if (htm_data != null) {
            try {
    ...
    private void displayBSLData(String htm_sensor_data) {
		LogUtil.e("HealthTemperatureService", "displayBSLData()");
    ...
    private float convertFahrenheitToCelcius(float fahrenheit) {
		LogUtil.e("HealthTemperatureService", "convertFahrenheitToCelcius()");
    ...
    public void onResume() {
        super.onResume();
		LogUtil.e("HealthTemperatureService", "onResume()");
        mHandlerFlag = true;
    ...
    public void onDestroy() {
		LogUtil.e("HealthTemperatureService", "onDestroy()");
        mHandlerFlag = false;
    ...
    void stopBroadcastDataIndiacte(
		...
		LogUtil.e("HealthTemperatureService", "stopBroadcastDataIndiacte()");
    ...
    void prepareBroadcastDataIndicate(
            BluetoothGattCharacteristic gattCharacteristic) {
		LogUtil.e("HealthTemperatureService", "prepareBroadcastDataIndicate()");
        if ((gattCharacteristic.getProperties() | BluetoothGattCharacteristic.PROPERTY_INDICATE) > 0) {
    ...
    void prepareBroadcastDataRead(
            BluetoothGattCharacteristic gattCharacteristic) {
		LogUtil.e("HealthTemperatureService", "prepareBroadcastDataRead()");
     ...
     */
    void getGattData() {
		LogUtil.e("HealthTemperatureService", "getGattData()");
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
		LogUtil.e("HealthTemperatureService", "onCreateOptionsMenu()");
        menu.clear();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
		LogUtil.e("HealthTemperatureService", "onOptionsItemSelected()");
    ...
    private void setupChart(View parent) {
		LogUtil.e("HealthTemperatureService", "setupChart()");
        /**
