...
public class CapsenseServiceSlider extends Fragment {
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
			LogUtil.e("CapsenseServiceSlider", "mGattUpdateReceiver onReceive()");
    ...
    public CapsenseServiceSlider create(BluetoothGattService service) {
		LogUtil.e("CapsenseServiceSlider", "create()");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		LogUtil.e("CapsenseServiceSlider", "onCreateView()");
    ...
    private void displayLiveData(int sliding_data) {
		LogUtil.e("CapsenseServiceSlider", "displayLiveData()");
        int slided;
    ...
    public void onResume() {
        super.onResume();
		LogUtil.e("CapsenseServiceSlider", "onResume()");
    ...
    public void onDestroy() {
		LogUtil.e("CapsenseServiceSlider", "onDestroy()");
