...
public class RGBFragment extends Fragment {
    ...
    private BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
			LogUtil.e("RGBFragment", "mGattUpdateReceiver  onReceive()");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		LogUtil.e("RGBFragment", "onCreateView()");
    ...
    private void setDefaultColorPickerPositionColor() {
		LogUtil.e("RGBFragment", "setDefaultColorPickerPositionColor()");
     ...
     */
    void setUpControls() {
		LogUtil.e("RGBFragment", "setUpControls()");
    ...
    public void onResume() {
		LogUtil.e("RGBFragment", "onResume()");
    ...
    public void onDestroy() {
		LogUtil.e("RGBFragment", "onDestroy()");
    ...
    private void UIupdation() {
		LogUtil.e("RGBFragment", "UIupdation()");
     ...
     */
    void getGattData() {
		LogUtil.e("RGBFragment", "getGattData()");
    ...
    void moveTarget() {
		LogUtil.e("RGBFragment", "moveTarget()");
    ...
    private float getwidth() {
		LogUtil.e("RGBFragment", "getwidth()");
        return mWidth;
    }

    private float getheigth() {
		LogUtil.e("RGBFragment", "getheigth()");
        return mHeight;
    }

    private void setwidth(float sat) {
		LogUtil.e("RGBFragment", "setwidth()");
        mWidth = sat;
    }

    private void setheight(float val) {
		LogUtil.e("RGBFragment", "setheight()");
        mHeight = val;
    }

    @Override
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
		LogUtil.e("RGBFragment", "onCreateOptionsMenu()");
        menu.clear();
    ...
    public void onConfigurationChanged(Configuration newConfig) {
		LogUtil.e("RGBFragment", "onConfigurationChanged()");
