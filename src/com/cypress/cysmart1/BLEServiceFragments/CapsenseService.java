...
import com.cypress.cysmart1.CommonUtils.DepthPageTransformer;
import com.cypress.cysmart1.CommonUtils.LogUtil;
import com.cypress.cysmart1.CommonUtils.Logger;
import com.cypress.cysmart1.CommonUtils.PagerFooterview;
...
public class CapsenseService extends Fragment {
    ...
    public CapsenseService create(BluetoothGattService service, int pageCount) {
		LogUtil.e("CapsenseService", "create()");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		LogUtil.e("CapsenseService", "onCreateView()");						 
    ...
    public void onResume() {
        super.onResume();
		LogUtil.e("CapsenseService", "onResume()");	
        mNotifyset = false;
    ...
    public void onDestroy() {
		LogUtil.e("CapsenseService", "onDestroy()");	
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        public ScreenSlidePagerAdapter(FragmentManager fm) {
            super(fm);
            LogUtil.e("CapsenseService  ScreenSlidePagerAdapter", "ScreenSlidePagerAdapter()");
        }

        @Override
        public Fragment getItem(int position) {
			LogUtil.e("CapsenseService  ScreenSlidePagerAdapter", "getItem()");	
            return fragmentsList.get(position);
        }

        @Override
        public int getCount() {
			LogUtil.e("CapsenseService  ScreenSlidePagerAdapter", "getCount()");	
    ...
    void prepareBroadcastDataNotify(
            BluetoothGattCharacteristic gattCharacteristic) {
				LogUtil.e("CapsenseService", "prepareBroadcastDataNotify()");	
    ...
    private static void stopBroadcastDataNotify(
            BluetoothGattCharacteristic gattCharacteristic) {
		LogUtil.e("CapsenseService", "stopBroadcastDataNotify()");
        if ((gattCharacteristic.getProperties() | BluetoothGattCharacteristic.PROPERTY_NOTIFY) > 0) {
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
			LogUtil.e("CapsenseService", "mGattUpdateReceiver  onReceive()");
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
		LogUtil.e("CapsenseService", "onCreateOptionsMenu()");
        menu.clear();
