...
public class GlucoseAdditionalInfo extends Fragment {
    ...
    public GlucoseAdditionalInfo create(BluetoothGattService service) {
		LogUtil.e("GlucoseAdditionalInfo", "create()");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		LogUtil.e("GlucoseAdditionalInfo", "onCreateView()");
    ...
    private void getDataBundle(Bundle extras) {
		LogUtil.e("GlucoseAdditionalInfo", "getDataBundle()");
    ...
    void prepareBroadcastDataRead(
		...
		LogUtil.e("GlucoseAdditionalInfo", "prepareBroadcastDataRead()");
    ...
    public void onResume() {
        super.onResume();
		LogUtil.e("GlucoseAdditionalInfo", "onResume()");
    }
    ...
    public void onPause() {
        super.onPause();
		LogUtil.e("GlucoseAdditionalInfo", "onPause()");
    }


    @Override
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
		LogUtil.e("GlucoseAdditionalInfo", "onCreateOptionsMenu()");
        menu.clear();
