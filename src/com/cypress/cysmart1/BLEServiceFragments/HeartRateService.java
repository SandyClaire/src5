...
public class HeartRateService extends Fragment {
    ...
    private BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
			LogUtil.e("HeartRateService", "mGattUpdateReceiver  onReceive()");
    ...
    public HeartRateService create(BluetoothGattService service) {
		LogUtil.e("HeartRateService", "create()");
        mService = service;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		LogUtil.e("HeartRateService", "onCreateView()");
    ...
    private void displayBSLData(String hrm_body_sensor_data) {
		LogUtil.e("HeartRateService", "displayBSLData()");
    ...
    private void displayHRMData(final String hrm_data) {
		LogUtil.e("HeartRateService", "displayHRMData()");
        if (hrm_data != null) {
    ...
    private void displayHRMEEData(String hrm_ee_data) {
		LogUtil.e("HeartRateService", "displayHRMEEData()");
        if (hrm_ee_data != null) {
    ...
    private void displayHRMRRData(ArrayList<Integer> hrm_rr_data) {
		LogUtil.e("HeartRateService", "displayHRMRRData()");
        if (hrm_rr_data != null) {
    ...
    public void onResume() {
        super.onResume();
		LogUtil.e("HeartRateService", "onResume()");
        mHandlerFlag = true;
    ...
    public void onDestroy() {
		LogUtil.e("HeartRateService", "onDestroy()");
        mHandlerFlag = false;
    ...
    void stopBroadcastDataNotify(
		...
		LogUtil.e("HeartRateService", "stopBroadcastDataNotify()");
    ...
    void prepareBroadcastDataRead(
            BluetoothGattCharacteristic gattCharacteristic) {
		LogUtil.e("HeartRateService", "prepareBroadcastDataRead()");
    ...
    void prepareBroadcastDataNotify(
            BluetoothGattCharacteristic gattCharacteristic) {
		LogUtil.e("HeartRateService", "prepareBroadcastDataNotify()");
     ...
     */
    void getGattData() {
		LogUtil.e("HeartRateService", "getGattData()");
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
		LogUtil.e("HeartRateService", "onCreateOptionsMenu()");
        menu.clear();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
		LogUtil.e("HeartRateService", "onOptionsItemSelected()");
    ...
    private void setupChart(View parent) {
		LogUtil.e("HeartRateService", "setupChart()");
        /**
