...
public class CapsenseServiceProximity extends Fragment {
    ...
    public CapsenseServiceProximity create(BluetoothGattService service) {
		LogUtil.e("CapsenseServiceProximity", "create()");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		LogUtil.e("CapsenseServiceProximity", "onCreateView()");
    ...
    public static void displayLiveData(int proximity_value) {
		LogUtil.e("CapsenseServiceProximity", "displayLiveData()");
    ...
    public void onResume() {
        super.onResume();
		LogUtil.e("CapsenseServiceProximity", "onResume()");
        mMediaPlayer = MediaPlayer.create(getActivity(), R.raw.beep);
        mValueIncreased = true;
    }
    ...
    @Override
    public void onPause() {
		LogUtil.e("CapsenseServiceProximity", "onPause()");
