...
import com.cypress.cysmart1.DataModelClasses.CapSenseButtonsGridModel;
import com.cypress.cysmart1.ListAdapters.CapSenseButtonsGridAdapter;
...
public class CapsenseServiceButtons extends Fragment {
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
			LogUtil.e("CapsenseServiceButtons", "mGattUpdateReceiver onReceive()");
    ...
    public CapsenseServiceButtons create(BluetoothGattService service) {
		LogUtil.e("CapsenseServiceButtons", "create()");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		LogUtil.e("CapsenseServiceButtons", "onCreateView()");
    ...
    private void displayLiveData(ArrayList<Integer> button_data) {
		LogUtil.e("CapsenseServiceButtons", "displayLiveData()");
    ...
    public void onResume() {
        super.onResume();
		LogUtil.e("CapsenseServiceButtons", "onResume()");
    ...
    public void onDestroy() {
        super.onDestroy();
		LogUtil.e("CapsenseServiceButtons", "onDestroy()");
    ...
    private void fillButtons(int buttons) {
		LogUtil.e("CapsenseServiceButtons", "fillButtons()");
        mData.clear();
    ...
    private void setDataAdapter() {
		LogUtil.e("CapsenseServiceButtons", "setDataAdapter()");
