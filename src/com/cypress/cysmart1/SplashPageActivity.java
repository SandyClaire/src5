...
public class SplashPageActivity extends Activity {
    ...
    private Runnable mRun = new Runnable() {
        ...
        @Override
        public void run() {
            LogUtil.e("SplashPageActivity", "mRun  run()");
            if (mHandlerFlag) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LogUtil.e("SplashPageActivity", "onCreate()");
        if (isTablet(this)) {
            Logger.d("Tablet");
    ...
    public void onBackPressed() {
        LogUtil.e("SplashPageActivity", "onBackPressed()");
        /**
    ...
    private static boolean isTablet(Context context) {
        LogUtil.e("SplashPageActivity", "isTablet()");
