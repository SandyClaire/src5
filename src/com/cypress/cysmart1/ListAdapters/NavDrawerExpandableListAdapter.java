...
public class NavDrawerExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public NavDrawerExpandableListAdapter(Context context,
		...
		LogUtil.e("NavDrawerExpandableListAdapter", "NavDrawerExpandableListAdapter()");
    ...
    public int getGroupCount() {
		LogUtil.e("NavDrawerExpandableListAdapter", "getGroupCount()");
        return this.mHeaderData.size();
    }

    @Override
    public int getChildrenCount(int groupPosition) {
		LogUtil.e("NavDrawerExpandableListAdapter", "getChildrenCount()");
    ...
    public Object getGroup(int groupPosition) {
		LogUtil.e("NavDrawerExpandableListAdapter", "getGroup()");
        return this.mHeaderData.get(groupPosition);
    }

    @Override
    public Object getChild(int groupPosition, int childPosititon) {
		LogUtil.e("NavDrawerExpandableListAdapter", "getChild()");
        return this.mChildData.get(this.mHeaderData.get(groupPosition))
                .get(childPosititon);
    }
    ...
    public long getGroupId(int groupPosition) {
		LogUtil.e("NavDrawerExpandableListAdapter", "getGroupId()");
        return groupPosition;
    }

    @Override
    public long getChildId(int groupPosition, int childPosition) {
		LogUtil.e("NavDrawerExpandableListAdapter", "getChildId()");
        return childPosition;
    }

    @Override
    public boolean hasStableIds() {
		LogUtil.e("NavDrawerExpandableListAdapter", "hasStableIds()");
        return false;
    }

    @Override
    public View getGroupView(int position, boolean b, View convertView, ViewGroup parent) {
		LogUtil.e("NavDrawerExpandableListAdapter", "getGroupView()");
        if (convertView == null) {
    ...
    public View getChildView(int groupPosition, int childPosition,
		...
		LogUtil.e("NavDrawerExpandableListAdapter", "getChildView()");
    ...
    public boolean isChildSelectable(int i, int i1) {
		LogUtil.e("NavDrawerExpandableListAdapter", "isChildSelectable()");
        return true;
    }
