...
public class GattServiceListAdapter extends BaseAdapter {
    ...
    public GattServiceListAdapter(Context mContext,
		...
		LogUtil.e("GattServiceListAdapter", "GattServiceListAdapter()");
    ...
    @Override
    public int getCount() {
		LogUtil.e("GattServiceListAdapter", "getCount()");
        return mGattServiceData.size();
    }

    @Override
    public Object getItem(int i) {
		LogUtil.e("GattServiceListAdapter", "getItem()");
        return mGattServiceData.get(i);
    }

    @Override
    public long getItemId(int i) {
		LogUtil.e("GattServiceListAdapter", "getItemId()");
        return i;
    }

    @Override
    public View getView(int i, View view, ViewGroup viewGroup) {
		LogUtil.e("GattServiceListAdapter", "getView()");
