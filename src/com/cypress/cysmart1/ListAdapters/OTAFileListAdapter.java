...
import com.cypress.cysmart1.DataModelClasses.OTAFileModel;
...
public class OTAFileListAdapter extends BaseAdapter {
    ...
    public OTAFileListAdapter(Context context, ArrayList<OTAFileModel> fileList,
		...
		LogUtil.e("OTAFileListAdapter", "OTAFileListAdapter()");
    ...
    @Override
    public int getCount() {
		LogUtil.e("OTAFileListAdapter", "getCount()");
        return mFileList.size();
    }

    @Override
    public Object getItem(int position) {
		LogUtil.e("OTAFileListAdapter", "getItem()");
        return mFileList.get(position);
    }

    @Override
    public long getItemId(int position) {
		LogUtil.e("OTAFileListAdapter", "getItemId()");
        return position;
    }

    @Override
    public View getView(final int position, View convertView, ViewGroup parent) {
		LogUtil.e("OTAFileListAdapter", "getView()");
    ...
    public void addFiles(ArrayList<OTAFileModel> fileModels) {
		LogUtil.e("OTAFileListAdapter", "addFiles()");
