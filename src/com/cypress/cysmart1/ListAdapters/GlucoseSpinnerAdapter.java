...
public class GlucoseSpinnerAdapter extends BaseAdapter {
    ...
    public GlucoseSpinnerAdapter(Context context, SparseArray<GlucoseRecord> records) {
		LogUtil.e("GlucoseSpinnerAdapter", "GlucoseSpinnerAdapter()");
    ...
    public int getCount() {
		LogUtil.e("GlucoseSpinnerAdapter", "getCount()");
        return mRecords.size();
    }

    public GlucoseRecord getItem(int position) {
		LogUtil.e("GlucoseSpinnerAdapter", "getItem()");
        return mRecords.valueAt(position);
    }

    public long getItemId(int position) {
		LogUtil.e("GlucoseSpinnerAdapter", "getItemId()");
        return position;
    }

    @Override
    public View getView(final int position, final View convertView, final ViewGroup parent) {
		LogUtil.e("GlucoseSpinnerAdapter", "getView()");
