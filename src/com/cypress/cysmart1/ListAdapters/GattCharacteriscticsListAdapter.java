...
public class GattCharacteriscticsListAdapter extends BaseAdapter {
    ...
    public GattCharacteriscticsListAdapter(Context mContext,
		...
		LogUtil.e("GattCharacteriscticsListAdapter", "GattCharacteriscticsListAdapter()");
    ...
    @Override
    public int getCount() {
		LogUtil.e("GattCharacteriscticsListAdapter", "getCount()");
        return mGattCharacteristics.size();
    }

    @Override
    public Object getItem(int i) {
		LogUtil.e("GattCharacteriscticsListAdapter", "getItem()");
        return mGattCharacteristics.get(i);
    }

    @Override
    public long getItemId(int i) {
		LogUtil.e("GattCharacteriscticsListAdapter", "getItemId()");
        return i;
    }

    @Override
    public View getView(int i, View view, ViewGroup viewGroup) {
		LogUtil.e("GattCharacteriscticsListAdapter", "getView()");
    ...
    boolean getGattCharacteristicsPropertices(int characteristics,
        ...
        LogUtil.e("GattCharacteriscticsListAdapter", "getGattCharacteristicsPropertices()");
