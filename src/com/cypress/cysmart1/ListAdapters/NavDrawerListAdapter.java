...
public class NavDrawerListAdapter extends BaseAdapter {
    ...
    public NavDrawerListAdapter(Context context,
		...
		LogUtil.e("NavDrawerListAdapter", "NavDrawerListAdapter()");
    ...
    @Override
    public int getCount() {
		LogUtil.e("NavDrawerListAdapter", "getCount()");
        return mNavDrawerItems.size();
    }

    @Override
    public Object getItem(int position) {
		LogUtil.e("NavDrawerListAdapter", "getItem()");
        return mNavDrawerItems.get(position);
    }

    @Override
    public long getItemId(int position) {
		LogUtil.e("NavDrawerListAdapter", "getItemId()");
        return position;
    }

    @Override
    public View getView(int position, View convertView, ViewGroup parent) {
		LogUtil.e("NavDrawerListAdapter", "getView()");
        if (convertView == null) {
