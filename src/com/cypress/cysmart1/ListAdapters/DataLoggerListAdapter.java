...
import com.cypress.cysmart1.DataModelClasses.DataLoggerModel;
...
public class DataLoggerListAdapter extends BaseAdapter {
    ...
    public DataLoggerListAdapter(Context context, ArrayList<DataLoggerModel> list) {
		LogUtil.e("DataLoggerListAdapter", "DataLoggerListAdapter()");
    ...
    @Override
    public int getCount() {
		LogUtil.e("DataLoggerListAdapter", "getCount()");
        return mListItemName.size();
    }

    @Override
    public Object getItem(int i) {
		LogUtil.e("DataLoggerListAdapter", "getItem()");
        return mListItemName.get(i);
    }

    @Override
    public long getItemId(int i) {
		LogUtil.e("DataLoggerListAdapter", "getItemId()");
        return i;
    }

    @Override
    public View getView(final int position, View view, ViewGroup viewGroup) {
		LogUtil.e("DataLoggerListAdapter", "getView()");
