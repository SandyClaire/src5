...
public class DataLogsListAdapter extends BaseAdapter {
    ...
    public DataLogsListAdapter(Context context, ArrayList<String> list) {
		LogUtil.e("DataLogsListAdapter", "DataLogsListAdapter()");
        this.mContext = context;
        this.mStrings = list;
    }

    public void addData(ArrayList<String> newData) {
		LogUtil.e("DataLogsListAdapter", "addData()");
        this.mStrings = newData;
    }

    @Override
    public int getCount() {
		LogUtil.e("DataLogsListAdapter", "getCount()");
        return mStrings.size();
    }

    @Override
    public Object getItem(int i) {
		LogUtil.e("DataLogsListAdapter", "getItem()");
        return mStrings.get(i);
    }

    @Override
    public long getItemId(int i) {
		LogUtil.e("DataLogsListAdapter", "getItemId()");
        return i;
    }

    @Override
    public View getView(int position, View view, ViewGroup parent) {
		LogUtil.e("DataLogsListAdapter", "getView()");
