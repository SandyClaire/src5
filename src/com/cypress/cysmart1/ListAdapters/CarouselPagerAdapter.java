...
import com.cypress.cysmart1.CommonFragments.CarouselFragment;
...
import com.cypress.cysmart1.HomePageActivity;
...
public class CarouselPagerAdapter extends FragmentPagerAdapter implements
    ...
    public CarouselPagerAdapter(Activity context,
		...
		LogUtil.e("CarouselPagerAdapter", "CarouselPagerAdapter()");
    ...
    public Fragment getItem(int position) {
        LogUtil.e("CarouselPagerAdapter", "getItem()");
    ...
    @Override
    public int getCount() {
		LogUtil.e("CarouselPagerAdapter", "getCount()");
    ...
    public void onPageScrolled(int position, float positionOffset,
		...
		LogUtil.e("CarouselPagerAdapter", "onPageScrolled()");
        /**
    ...
    public void onPageSelected(int position) {
        LogUtil.e("CarouselPagerAdapter", "onPageSelected()");
    }

    @Override
    public void onPageScrollStateChanged(int state) {
		LogUtil.e("CarouselPagerAdapter", "onPageScrollStateChanged()");
    }

    private CarouselLinearLayout getRootView(int position) {
		LogUtil.e("CarouselPagerAdapter", "getRootView()");
    ...
    private String getFragmentTag(int position) {
		LogUtil.e("CarouselPagerAdapter", "getFragmentTag()");
