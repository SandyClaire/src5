...
-(void) setCharacteristicUpdates{
    ...
    if (recordAccessControlPointChar) {
        [[[CBManager sharedManager] myPeripheral] setNotifyValue:YES forCharacteristic:recordAccessControlPointChar];
    ...
    if(glucoseMeasurementContextChar){
        [[[CBManager sharedManager] myPeripheral] setNotifyValue:YES forCharacteristic:glucoseMeasurementContextChar];
...
-(void) writeRACPCharacteristicWithValueString:(NSString *)Value{
    ...
    if (recordAccessControlPointChar != nil) {
        ...
        [[[CBManager sharedManager] myPeripheral] writeValue:dataToWrite forCharacteristic:recordAccessControlPointChar type:CBCharacteristicWriteWithResponse];
    }
}
...
-(void) stopUpdate
{
    ...
    if (recordAccessControlPointChar) {
        if (recordAccessControlPointChar.isNotifying) {
            ...
            [[[CBManager sharedManager] myPeripheral] setNotifyValue:NO forCharacteristic:recordAccessControlPointChar];
        }
    }
    ...
    if (glucoseMeasurementContextChar) {
        if (glucoseMeasurementContextChar.isNotifying) {
            ...
            [[[CBManager sharedManager] myPeripheral] setNotifyValue:NO forCharacteristic:glucoseMeasurementContextChar];
        }
    }
